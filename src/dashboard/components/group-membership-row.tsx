 ...
 * channel — picking another fires `changePriceListGroup`. Changing the
 * group is a channel-local action: the parent enables it only for the
 * active channel's row (server requires ctx.channel === the row's
 * channel), so the Select is disabled when `disabled`.
 *
